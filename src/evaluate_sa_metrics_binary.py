...
def to_binary_labels(labels) -> list[int]:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate the binary SA transformer model.")
    ...
    if not model_dir.exists():
        raise FileNotFoundError("No se ha encontrado models/sa_transformer_binary.")
